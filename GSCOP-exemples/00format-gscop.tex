%%% Example of a presentation using LaTeX-beamer theme for G-SCOP
...
\usetheme[fancy,itemshape=square,progressbar=yes]{GSCOP}
...
% === document info ===========================================================
\title[Format \LaTeX\ G-SCOP]{Format \LaTeX-beamer pour G-SCOP}%
\subtitle{(exemple d'utilisation)}
\author[Lemaire]{Pierre Lemaire}%
\institute{G-SCOP, Grenoble}
\date{juin 2016}%
...
%% =============================================================================
\section[Introduction]{Introduction au thème G-SCOP}
\subsection{Un thème \LaTeX-beamer pour G-SCOP}

%% -----------------------------------------------------------------------------
\begin{frame}
  \frametitle{A propos de ce document}
  
  Ce document est une présentation \LaTeX\ réalisée avec la classe beamer et un thème adapté au G-SCOP
...
\frame{%
  ...
  Le thème \LaTeX-beamer pour G-SCOP est disponible sur \url{http://www.kamick.org/lemaire/dev.html}

  \bigskip

  Les fichiers de définition du
  thème\footnote{\texttt{beamerthemeGSCOP.sty},
    \texttt{beamercolorthemeGSCOP.sty}} et les
...
\frame{%
  ...
  \item \option{fancy}~:  toutes les options à \option{fancy}
    ...
    \begin{exampleblock}{\footnotesize Exemple}\footnotesize
      \string\usetheme[simple]\string{GSCOP\string}
    \end{exampleblock}
  \end{itemize}
}
...
\frame[allowframebreaks]{%
  ...
  \begin{exampleblock}{\footnotesize Exemples}\footnotesize
    \string\usetheme[headline=none,progressbar=yes]\string{GSCOP\string}

    \string\usetheme[fancy,framecount=plain,progressbar=yes]\string{GSCOP\string}
  \end{exampleblock}
}
...
% \subsection{Exemples de choix de tailles de diapos}
% \def\x#1#2#3{%
%   \centering
%   \begin{exampleblock}{}\scriptsize
