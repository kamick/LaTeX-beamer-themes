...
%%% (c) Pierre Lemaire, 2015, 2016, 2017, 2020, 2021
...
\usetheme[fancy,itemshape=square,progressbar=yes]{GI}
%\usetheme[simple,progressbar=large]{GI}
%\usetheme[none,colorstyle=fancy,footline=plain,framecount=plain,progressbar=yes]{GI}
...
\pgfdeclareimage[height=2.5mm]{cc-nc-sa}{cc-by-nc-sa.png}%
\def\cc{\lower.2em\hbox{\href{https://creativecommons.org/licenses/by-nc-sa/4.0/}{\pgfuseimage{cc-nc-sa}}}}

% === document info ===========================================================
\title[Format \LaTeX\ GI]{Format \LaTeX-beamer pour GI}%
\subtitle{(exemple d'utilisation)}
\author[\cc\ P. Lemaire, GI, 2016--2021]{Pierre Lemaire}%
...
\frame{%
  ...
  \begin{itemize}
  \item \option{none}~:   toutes les options à \option{none} et pas de fond
  \item \option{bare}~:   toutes les options à \option{none}
...
\frame[allowframebreaks]{%
  ...
  \item \option{progressbar}~: barre de progression
    \begin{itemize}
      \item \option{no} (defaut)~: pas de barre de progression sur le pied-de-page
      \item \option{yes}~: ajoute une fine barre de progression sur le pied-de-page
      \item \option{large}~: ajoute une barre de progression sur le pied-de-page
    \end{itemize}
  \end{itemize}
  \smallskip
  \begin{exampleblock}{\footnotesize Exemples}\footnotesize
    \string\usetheme[headline=none,progressbar=large]\string{GI\string}
...
\frame{%
  ...
  \begin{itemize}
  \item \option{colorstyle}~: couleurs du texte et des titres
    \begin{itemize}
...
\frame[b,allowframebreaks]{
  ...
  \x{8}{none,colorstyle=fancy,footline=plain,framecount=plain,progressbar=yes}
}
